...
public class EV3RosActivity extends Activity {
    private static final String ACTIVITY_LOG = "ACTIVITY";
    private static final String SYSTEM_LOG = "SYSTEM";
    private static final String SERVICE_LOG = "SERVICE";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        log(Log.INFO, ACTIVITY_LOG, "Started");
        ...
        detachReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                log(Log.INFO, SYSTEM_LOG, "Device detached: " + name);
                updateButtons(EV3RosActivity.this.isRunning());
            }
        };
        ...
        stopButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                log(Log.WARN, ACTIVITY_LOG, "Stopping");
                runTask.cancel(true);
                stopButton.setPressed(true);
                for (int i = 0; EV3RosActivity.this.isRunning() && i < 100; i++) {
                    try {
                        Thread.sleep(10);
    ...
    protected void onResume() {
        ...
        if (intent != null) {
            ...
            if (UsbManager.ACTION_USB_DEVICE_ATTACHED.equals(action)) {
                UsbDevice usbDevice = intent.getParcelableExtra(UsbManager.EXTRA_DEVICE);
                log(Log.INFO, SYSTEM_LOG, "Device attached: " + usbDevice.getDeviceName());
